...
export async function seed(knex) {
  ...
  await knex('swipes').insert([
    // Sarah's swipes
    { id: 1, user_id: 1, movie_id: 550, liked: true }, // Fight Club
    { id: 2, user_id: 1, movie_id: 27205, liked: true }, // Inception
    { id: 3, user_id: 1, movie_id: 680, liked: true }, // Pulp Fiction
    { id: 4, user_id: 1, movie_id: 13, liked: false },
    // John's swipes
